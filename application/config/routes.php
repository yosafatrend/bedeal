...
$route['daftar'] = 'UserController/regist';
$route['role'] = 'UserController/editrole';
$route['bayar'] = 'UserController/bayar';
$route['riwayat'] = 'UserController/tampiltransaksi';
$route['riwayatp'] = 'UserController/tampilpenjual';
$route['chat'] = 's/ChatController/index';
$route['detail'] = 'UserController/detail';
